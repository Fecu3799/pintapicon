...
class NewUserDialog : DialogFragment() {
    ...
    private fun initViews() {
        ...
        userPassword = requireView().findViewById(R.id.et_userPassword)
        ...
        btn_save = requireView().findViewById(R.id.btn_save)
        btn_cancel = requireView().findViewById(R.id.btn_cancel)
